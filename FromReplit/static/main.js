...
const totalTime = 20; //Total time (seconds)
const minLevel = 1;
...
function countdown() {
	...
	if (time < 1) {
		...
		document.SaveResult.ResultPoints.value = points;
		document.SaveResult.ResultTime.value = totalTime;
		document.SaveResult.ResultLevel.value = level;
